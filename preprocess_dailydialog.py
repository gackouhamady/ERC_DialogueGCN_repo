...
if __name__ == '__main__':
    ...
    pickle.dump([convSpeakers, convInputSequence, convInputMaxSequenceLength, convActLabels, convEmotionLabels,
                 train_conv_ids, test_conv_ids, valid_conv_ids], open('data/dailydialog/daily_dialogue2.pkl', 'wb'))
    ...
    np.ndarray.dump(glv_embedding_matrix, open('data/dailydialog/glv_embedding_matrix2', 'wb'))
